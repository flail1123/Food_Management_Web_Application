const date = new Date();
const el = document.getElementById('custom_month')
if (el.value != '' && el.value != null) {
    date.setMonth(parseInt(el.value) - 1);
}
const el2 = document.getElementById('custom_year')
if (el2.value != '' && el2.value != null) {
    date.setFullYear(parseInt(el2.value));
}
let lastDay;
